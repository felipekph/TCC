function save_fig2(Nome,mode,Fig,SavePdf,SavePng,SaveJpg,SaveFig,resolution,xaxis,fechar,append,extraSpace,render)
 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if nargin<3; Fig = gcf; SavePdf=1; SavePng=0; SaveFig=0; SaveJpg=0; resolution=200; xaxis=''; fechar=0; append=0; extraSpace=0; render='painters'; end;
