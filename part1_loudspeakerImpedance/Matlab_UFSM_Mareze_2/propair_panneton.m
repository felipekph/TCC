function [ro,co,vis,gam,B2,Cp,kappla]=propair_panneton(To,Po,HR) %#ok<FNDEF>
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% po=1.4*101320; %N/m2 pressao cavidade
% Cp=2.1603e3;                                                    %cp do R600a
% Cv=1.7949e3;                                                    %cv do R600a
% gam=Cp/Cv;                                                     %relacao entre cp e cv       
% co=189.70;                                                      %velocidade do som no isobutano
% ro=22.427;                                                     %densidade do R600
% vis=8.5555*1e-6;                                                 %viscosidade do R600 
% kappla=0.021172;                                                %condutibilidade termica    W/m-K
% B2=(vis*Cp/kappla);                                              %numero de Prandtl
% B=sqrt(B2);
