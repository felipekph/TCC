...
calib = load('Dados\17_fevereiro\auditorio\calibracao\inicio\calibracao_V.mat');
sens = rms(calib.Recording);

% Near-field
load("Dados\17_fevereiro\auditorio\woofer\nf\nf.mat");
...
% Far-field
ff = load("Dados\17_fevereiro\auditorio\woofer\ff\ff.mat");
...
print(gcf, '-dpng', '-r300', 'Figuras\auditorio_campoProximo&Distante_normalizados.png')
